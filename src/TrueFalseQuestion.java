...
public class TrueFalseQuestion extends MultipleChoiceQuestion {
	...
	public Answer takeAnswer() {
		...
		String choice = "";
		while (!choice.equalsIgnoreCase("T") && !choice.equalsIgnoreCase("F") && !choice.equalsIgnoreCase("True")
				&& !choice.equalsIgnoreCase("False")) {
			System.out.print("Enter your answer (T/F): ");
			choice = scanner.nextLine().trim();

			if (!choice.equalsIgnoreCase("T") && !choice.equalsIgnoreCase("F") && !choice.equalsIgnoreCase("True")
					&& !choice.equalsIgnoreCase("False")) {
